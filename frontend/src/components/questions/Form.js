    ...
    case 1:
        ...
        <div className="w-full md:w-[40rem] px-8 pb-[4em] -mt-[4rem]">
          <Box
            sx={{
              ...
              boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1), 0px 8px 16px rgba(0, 0, 0, 0.1)', // 3D box shadow
      ...
      <div className="flex gap-3">
        ...
        <div aria-label="name-question">
          <FormLabel sx={{ fontSize: '1.3em', marginBottom: '8px', color: '#333' }}>
            First Name
          </FormLabel>
          <Input
            id="name"
        ...
        <div aria-label="sex-question">
          <FormLabel sx={{ fontSize: '1.3em', marginBottom: '8px' }}>Sex</FormLabel>
          <RadioGroup
      ...
      {/* Add more form elements here */}
            ...
            <div>
              <FormLabel aria-label="height-question" sx={{ fontSize: "1.3em" }}>
                Height
              </FormLabel>
              <div className="flex" >
                <Input
                ...
                <Input
                  ...
                  defaultValue={localStorage.getItem("byte_height_inches")}
                  slotProps={{
                    input: {
                      min: 0,
                      max: 1000,
      ...
      {[
        ...
        >
          <Radio
            ...
            sx={{ fontWeight: '500' }}
          />
          <Typography sx={{ color: 'grey' }}>{value.description}</Typography>
        </Sheet>
      ))}
    </div>
  </RadioGroup>
            ...
            <div className="w-full flex justify-between">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  if (!isvalid) {
                    setErrorState("Please fill out every question before continuing.");
                  } else {
