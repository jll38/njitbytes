...
function Form({ setQuizStatus }) {
  ...
  switch (quizStep) {
    ...
    case 1:
      return (
        <div className="w-full md:w-[40rem]" style={{ marginTop: isMobile ? "1rem" : "2rem", paddingBottom: isMobile ? "3rem" : "0" }}>
    <Box
      sx={{
        borderRadius: "12px",
    ...
    >
              <div className="flex flex-col gap-4">
                ...
                <div className={isMobile ? "flex flex-col gap-4" : "flex justify-between flex-col sm:flex-row items-center"}>
                  ...
                  <div style={isMobile ? {} : {marginRight: "1.6rem"}}>
                    <FormLabel
